...
@Entity
public class JISLJALEQS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JISLJALEQS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JISLJALEQS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JISLJALEQS(String[] strValues, int nSource) throws NumberFormatException {
