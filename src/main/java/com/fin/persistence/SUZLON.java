...
@Entity
public class SUZLON extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SUZLON(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SUZLON(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SUZLON(String[] strValues, int nSource) throws NumberFormatException {
