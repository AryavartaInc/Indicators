...
@Entity
public class JPASSOCIAT extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JPASSOCIAT(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JPASSOCIAT(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JPASSOCIAT(String[] strValues, int nSource) throws NumberFormatException {
