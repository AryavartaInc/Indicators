...
@Entity
public class OIL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public OIL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public OIL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public OIL(String[] strValues, int nSource) throws NumberFormatException {
