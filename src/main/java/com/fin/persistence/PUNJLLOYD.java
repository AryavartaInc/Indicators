...
@Entity
public class PUNJLLOYD extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PUNJLLOYD(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PUNJLLOYD(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PUNJLLOYD(String[] strValues, int nSource) throws NumberFormatException {
