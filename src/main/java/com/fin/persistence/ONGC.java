...
@Entity
public class ONGC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ONGC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ONGC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ONGC(String[] strValues, int nSource) throws NumberFormatException {
