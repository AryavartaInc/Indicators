...
@Entity
public class MCLEODRUSS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MCLEODRUSS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MCLEODRUSS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MCLEODRUSS(String[] strValues, int nSource) throws NumberFormatException {
