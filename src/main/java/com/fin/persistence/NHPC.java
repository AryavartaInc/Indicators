...
@Entity
public class NHPC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NHPC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NHPC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NHPC(String[] strValues, int nSource) throws NumberFormatException {
