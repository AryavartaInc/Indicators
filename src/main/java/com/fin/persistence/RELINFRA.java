...
@Entity
public class RELINFRA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RELINFRA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RELINFRA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RELINFRA(String[] strValues, int nSource) throws NumberFormatException {
