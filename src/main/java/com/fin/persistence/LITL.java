...
@Entity
public class LITL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public LITL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public LITL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public LITL(String[] strValues, int nSource) throws NumberFormatException {
