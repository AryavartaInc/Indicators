...
@Entity
public class JPPOWER extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JPPOWER(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JPPOWER(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JPPOWER(String[] strValues, int nSource) throws NumberFormatException {
