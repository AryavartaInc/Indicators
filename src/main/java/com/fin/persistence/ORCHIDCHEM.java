...
@Entity
public class ORCHIDCHEM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ORCHIDCHEM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ORCHIDCHEM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ORCHIDCHEM(String[] strValues, int nSource) throws NumberFormatException {
