...
@Entity
public class OPTOCIRCUI extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public OPTOCIRCUI(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public OPTOCIRCUI(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public OPTOCIRCUI(String[] strValues, int nSource) throws NumberFormatException {
