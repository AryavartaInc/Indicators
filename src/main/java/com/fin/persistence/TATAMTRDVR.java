...
@Entity
public class TATAMTRDVR extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATAMTRDVR(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATAMTRDVR(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATAMTRDVR(String[] strValues, int nSource) throws NumberFormatException {
