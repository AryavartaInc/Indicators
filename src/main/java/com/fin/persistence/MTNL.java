...
@Entity
public class MTNL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MTNL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MTNL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MTNL(String[] strValues, int nSource) throws NumberFormatException {
