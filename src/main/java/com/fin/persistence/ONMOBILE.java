...
@Entity
public class ONMOBILE extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ONMOBILE(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ONMOBILE(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ONMOBILE(String[] strValues, int nSource) throws NumberFormatException {
