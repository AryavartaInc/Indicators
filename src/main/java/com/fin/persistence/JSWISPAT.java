...
@Entity
public class JSWISPAT extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JSWISPAT(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JSWISPAT(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JSWISPAT(String[] strValues, int nSource) throws NumberFormatException {
