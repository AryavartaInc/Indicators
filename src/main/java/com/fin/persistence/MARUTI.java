...
@Entity
public class MARUTI extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MARUTI(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MARUTI(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MARUTI(String[] strValues, int nSource) throws NumberFormatException {
