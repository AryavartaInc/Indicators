...
@Entity
public class PNB extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PNB(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PNB(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PNB(String[] strValues, int nSource) throws NumberFormatException {
