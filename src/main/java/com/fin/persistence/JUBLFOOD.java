...
@Entity
public class JUBLFOOD extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JUBLFOOD(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JUBLFOOD(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JUBLFOOD(String[] strValues, int nSource) throws NumberFormatException {
