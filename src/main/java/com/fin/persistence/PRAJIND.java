...
@Entity
public class PRAJIND extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PRAJIND(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PRAJIND(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PRAJIND(String[] strValues, int nSource) throws NumberFormatException {
