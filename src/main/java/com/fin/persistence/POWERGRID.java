...
@Entity
public class POWERGRID extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public POWERGRID(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public POWERGRID(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public POWERGRID(String[] strValues, int nSource) throws NumberFormatException {
