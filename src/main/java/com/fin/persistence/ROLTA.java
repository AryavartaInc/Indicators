...
@Entity
public class ROLTA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ROLTA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ROLTA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ROLTA(String[] strValues, int nSource) throws NumberFormatException {
