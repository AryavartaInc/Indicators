...
@Entity
public class TATACOMM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATACOMM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATACOMM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATACOMM(String[] strValues, int nSource) throws NumberFormatException {
