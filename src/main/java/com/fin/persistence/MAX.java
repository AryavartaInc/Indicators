...
@Entity
public class MAX extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MAX(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MAX(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MAX(String[] strValues, int nSource) throws NumberFormatException {
