...
@Entity
public class RUCHISOYA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RUCHISOYA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RUCHISOYA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RUCHISOYA(String[] strValues, int nSource) throws NumberFormatException {
