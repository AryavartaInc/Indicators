...
@Entity
public class NATIONALUM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NATIONALUM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NATIONALUM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NATIONALUM(String[] strValues, int nSource) throws NumberFormatException {
