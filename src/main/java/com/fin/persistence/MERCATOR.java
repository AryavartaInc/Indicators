...
@Entity
public class MERCATOR extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MERCATOR(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MERCATOR(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MERCATOR(String[] strValues, int nSource) throws NumberFormatException {
