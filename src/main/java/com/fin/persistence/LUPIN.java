...
@Entity
public class LUPIN extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public LUPIN(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public LUPIN(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public LUPIN(String[] strValues, int nSource) throws NumberFormatException {
