...
@Entity
public class STER extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public STER(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public STER(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public STER(String[] strValues, int nSource) throws NumberFormatException {
