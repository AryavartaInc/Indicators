...
@Entity
public class SOBHA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SOBHA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SOBHA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SOBHA(String[] strValues, int nSource) throws NumberFormatException {
