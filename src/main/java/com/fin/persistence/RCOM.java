...
@Entity
public class RCOM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RCOM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RCOM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RCOM(String[] strValues, int nSource) throws NumberFormatException {
