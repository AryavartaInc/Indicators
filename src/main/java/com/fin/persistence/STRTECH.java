...
@Entity
public class STRTECH extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public STRTECH(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public STRTECH(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public STRTECH(String[] strValues, int nSource) throws NumberFormatException {
