...
@Entity
public class KSOILS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public KSOILS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public KSOILS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public KSOILS(String[] strValues, int nSource) throws NumberFormatException {
