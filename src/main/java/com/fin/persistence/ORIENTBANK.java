...
@Entity
public class ORIENTBANK extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ORIENTBANK(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ORIENTBANK(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ORIENTBANK(String[] strValues, int nSource) throws NumberFormatException {
