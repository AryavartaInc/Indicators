...
@Entity
public class NMDC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NMDC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NMDC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NMDC(String[] strValues, int nSource) throws NumberFormatException {
