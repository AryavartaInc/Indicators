...
@Entity
public class SUNTV extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SUNTV(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SUNTV(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SUNTV(String[] strValues, int nSource) throws NumberFormatException {
