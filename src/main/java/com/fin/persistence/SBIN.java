...
@Entity
public class SBIN extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SBIN(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SBIN(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SBIN(String[] strValues, int nSource) throws NumberFormatException {
