...
@Entity
public class SIEMENS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SIEMENS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SIEMENS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SIEMENS(String[] strValues, int nSource) throws NumberFormatException {
