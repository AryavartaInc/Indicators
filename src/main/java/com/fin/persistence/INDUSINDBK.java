...
@Entity
public class INDUSINDBK extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public INDUSINDBK(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public INDUSINDBK(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public INDUSINDBK(String[] strValues, int nSource) throws NumberFormatException {
