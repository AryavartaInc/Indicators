...
@Entity
public class IVRCLINFRA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public IVRCLINFRA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public IVRCLINFRA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public IVRCLINFRA(String[] strValues, int nSource) throws NumberFormatException {
