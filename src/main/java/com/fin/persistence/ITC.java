...
@Entity
public class ITC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public ITC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public ITC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public ITC(String[] strValues, int nSource) throws NumberFormatException {
