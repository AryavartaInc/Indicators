...
@Entity
public class OFSS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public OFSS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public OFSS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public OFSS(String[] strValues, int nSource) throws NumberFormatException {
