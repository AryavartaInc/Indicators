...
@Entity
public class PATELENG extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PATELENG(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PATELENG(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PATELENG(String[] strValues, int nSource) throws NumberFormatException {
