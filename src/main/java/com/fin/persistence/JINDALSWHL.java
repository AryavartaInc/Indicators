...
@Entity
public class JINDALSWHL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JINDALSWHL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JINDALSWHL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JINDALSWHL(String[] strValues, int nSource) throws NumberFormatException {
