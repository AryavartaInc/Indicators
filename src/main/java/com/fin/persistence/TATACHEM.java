...
@Entity
public class TATACHEM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATACHEM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATACHEM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATACHEM(String[] strValues, int nSource) throws NumberFormatException {
