...
@Entity
public class TEXINFRA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TEXINFRA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TEXINFRA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TEXINFRA(String[] strValues, int nSource) throws NumberFormatException {
