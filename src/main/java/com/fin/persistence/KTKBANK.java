...
@Entity
public class KTKBANK extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public KTKBANK(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public KTKBANK(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public KTKBANK(String[] strValues, int nSource) throws NumberFormatException {
