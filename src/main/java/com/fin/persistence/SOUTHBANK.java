...
@Entity
public class SOUTHBANK extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SOUTHBANK(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SOUTHBANK(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SOUTHBANK(String[] strValues, int nSource) throws NumberFormatException {
