...
@Entity
public class PATNI extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PATNI(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PATNI(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PATNI(String[] strValues, int nSource) throws NumberFormatException {
