...
@Entity
public class PFC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PFC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PFC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PFC(String[] strValues, int nSource) throws NumberFormatException {
