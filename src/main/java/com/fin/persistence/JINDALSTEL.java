...
@Entity
public class JINDALSTEL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JINDALSTEL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JINDALSTEL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JINDALSTEL(String[] strValues, int nSource) throws NumberFormatException {
