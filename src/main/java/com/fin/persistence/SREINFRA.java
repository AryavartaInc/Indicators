...
@Entity
public class SREINFRA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SREINFRA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SREINFRA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SREINFRA(String[] strValues, int nSource) throws NumberFormatException {
