...
@Entity
public class SINTEX extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SINTEX(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SINTEX(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SINTEX(String[] strValues, int nSource) throws NumberFormatException {
