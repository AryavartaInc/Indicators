...
@Entity
public class TECHM extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TECHM(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TECHM(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TECHM(String[] strValues, int nSource) throws NumberFormatException {
