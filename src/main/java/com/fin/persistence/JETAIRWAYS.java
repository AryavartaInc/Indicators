...
@Entity
public class JETAIRWAYS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JETAIRWAYS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JETAIRWAYS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JETAIRWAYS(String[] strValues, int nSource) throws NumberFormatException {
