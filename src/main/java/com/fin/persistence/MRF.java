...
@Entity
public class MRF extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MRF(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MRF(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MRF(String[] strValues, int nSource) throws NumberFormatException {
