...
@Entity
public class RELIANCE extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RELIANCE(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RELIANCE(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RELIANCE(String[] strValues, int nSource) throws NumberFormatException {
