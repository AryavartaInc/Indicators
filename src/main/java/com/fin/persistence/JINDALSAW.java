...
@Entity
public class JINDALSAW extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JINDALSAW(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JINDALSAW(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JINDALSAW(String[] strValues, int nSource) throws NumberFormatException {
