...
@Entity
public class MRPL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MRPL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MRPL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MRPL(String[] strValues, int nSource) throws NumberFormatException {
