...
@Entity
public class PIRHEALTH extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PIRHEALTH(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PIRHEALTH(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PIRHEALTH(String[] strValues, int nSource) throws NumberFormatException {
