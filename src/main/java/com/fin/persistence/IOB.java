...
@Entity
public class IOB extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public IOB(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public IOB(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public IOB(String[] strValues, int nSource) throws NumberFormatException {
