...
@Entity
public class IRB extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public IRB(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public IRB(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public IRB(String[] strValues, int nSource) throws NumberFormatException {
