...
@Entity
public class PANTALOONR extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PANTALOONR(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PANTALOONR(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PANTALOONR(String[] strValues, int nSource) throws NumberFormatException {
