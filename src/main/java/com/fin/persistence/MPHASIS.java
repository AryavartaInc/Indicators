...
@Entity
public class MPHASIS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MPHASIS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MPHASIS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MPHASIS(String[] strValues, int nSource) throws NumberFormatException {
