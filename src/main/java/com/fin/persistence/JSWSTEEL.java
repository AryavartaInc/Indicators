...
@Entity
public class JSWSTEEL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JSWSTEEL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JSWSTEEL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JSWSTEEL(String[] strValues, int nSource) throws NumberFormatException {
