...
@Entity
public class JSWENERGY extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public JSWENERGY(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public JSWENERGY(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public JSWENERGY(String[] strValues, int nSource) throws NumberFormatException {
