...
@Entity
public class SAIL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SAIL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SAIL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SAIL(String[] strValues, int nSource) throws NumberFormatException {
