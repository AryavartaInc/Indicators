...
@Entity
public class RECLTD extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RECLTD(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RECLTD(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RECLTD(String[] strValues, int nSource) throws NumberFormatException {
