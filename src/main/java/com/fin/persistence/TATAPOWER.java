...
@Entity
public class TATAPOWER extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATAPOWER(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATAPOWER(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATAPOWER(String[] strValues, int nSource) throws NumberFormatException {
