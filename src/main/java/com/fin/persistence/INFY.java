...
@Entity
public class INFY extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public INFY(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public INFY(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public INFY(String[] strValues, int nSource) throws NumberFormatException {
