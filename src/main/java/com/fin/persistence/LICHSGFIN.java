...
@Entity
public class LICHSGFIN extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public LICHSGFIN(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public LICHSGFIN(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public LICHSGFIN(String[] strValues, int nSource) throws NumberFormatException {
