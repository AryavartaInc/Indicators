...
@Entity
public class SYNDIBANK extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SYNDIBANK(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SYNDIBANK(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SYNDIBANK(String[] strValues, int nSource) throws NumberFormatException {
