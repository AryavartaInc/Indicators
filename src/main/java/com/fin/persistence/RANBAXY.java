...
@Entity
public class RANBAXY extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RANBAXY(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RANBAXY(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RANBAXY(String[] strValues, int nSource) throws NumberFormatException {
