...
@Entity
public class NCC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NCC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NCC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NCC(String[] strValues, int nSource) throws NumberFormatException {
