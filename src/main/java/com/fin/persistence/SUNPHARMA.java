...
@Entity
public class SUNPHARMA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SUNPHARMA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SUNPHARMA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SUNPHARMA(String[] strValues, int nSource) throws NumberFormatException {
