...
@Entity
public class MUNDRAPORT extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public MUNDRAPORT(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public MUNDRAPORT(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public MUNDRAPORT(String[] strValues, int nSource) throws NumberFormatException {
