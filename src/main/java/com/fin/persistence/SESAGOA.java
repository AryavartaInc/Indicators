...
@Entity
public class SESAGOA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SESAGOA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SESAGOA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SESAGOA(String[] strValues, int nSource) throws NumberFormatException {
