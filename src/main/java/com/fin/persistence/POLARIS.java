...
@Entity
public class POLARIS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public POLARIS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public POLARIS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public POLARIS(String[] strValues, int nSource) throws NumberFormatException {
