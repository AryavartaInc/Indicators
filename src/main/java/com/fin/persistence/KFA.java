...
@Entity
public class KFA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public KFA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public KFA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public KFA(String[] strValues, int nSource) throws NumberFormatException {
