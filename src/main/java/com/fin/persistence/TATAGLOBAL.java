...
@Entity
public class TATAGLOBAL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATAGLOBAL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATAGLOBAL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATAGLOBAL(String[] strValues, int nSource) throws NumberFormatException {
