...
@Entity
public class RPOWER extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RPOWER(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RPOWER(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RPOWER(String[] strValues, int nSource) throws NumberFormatException {
