...
@Entity
public class TCS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TCS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TCS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TCS(String[] strValues, int nSource) throws NumberFormatException {
