...
@Entity
public class NEYVELILIG extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NEYVELILIG(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NEYVELILIG(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NEYVELILIG(String[] strValues, int nSource) throws NumberFormatException {
