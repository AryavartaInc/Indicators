...
@Entity
public class TATASTEEL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATASTEEL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATASTEEL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATASTEEL(String[] strValues, int nSource) throws NumberFormatException {
