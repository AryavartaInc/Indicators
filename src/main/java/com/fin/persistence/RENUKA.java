...
@Entity
public class RENUKA extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RENUKA(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RENUKA(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RENUKA(String[] strValues, int nSource) throws NumberFormatException {
