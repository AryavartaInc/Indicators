...
@Entity
public class RELCAPITAL extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public RELCAPITAL(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public RELCAPITAL(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public RELCAPITAL(String[] strValues, int nSource) throws NumberFormatException {
