...
@Entity
public class SRTRANSFIN extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SRTRANSFIN(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SRTRANSFIN(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SRTRANSFIN(String[] strValues, int nSource) throws NumberFormatException {
