...
@Entity
public class IOC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public IOC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public IOC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public IOC(String[] strValues, int nSource) throws NumberFormatException {
