...
@Entity
public class PETRONET extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PETRONET(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PETRONET(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PETRONET(String[] strValues, int nSource) throws NumberFormatException {
