...
@Entity
public class TATAMOTORS extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public TATAMOTORS(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public TATAMOTORS(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public TATAMOTORS(String[] strValues, int nSource) throws NumberFormatException {
