...
@Entity
public class NTPC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public NTPC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public NTPC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public NTPC(String[] strValues, int nSource) throws NumberFormatException {
