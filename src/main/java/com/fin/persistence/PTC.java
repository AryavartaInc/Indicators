...
@Entity
public class PTC extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public PTC(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public PTC(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public PTC(String[] strValues, int nSource) throws NumberFormatException {
