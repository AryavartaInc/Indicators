...
@Entity
public class SCI extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SCI(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SCI(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SCI(String[] strValues, int nSource) throws NumberFormatException {
