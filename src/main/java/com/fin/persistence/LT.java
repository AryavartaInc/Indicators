...
@Entity
public class LT extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public LT(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public LT(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public LT(String[] strValues, int nSource) throws NumberFormatException {
