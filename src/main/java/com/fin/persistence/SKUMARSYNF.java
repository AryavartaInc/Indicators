...
@Entity
public class SKUMARSYNF extends StockTechnical implements Serializable {
	 ...
	 * @param turnover
	 */
	public SKUMARSYNF(Date tradeDate, double openPrice,
	 ...
	 * @param turnover
	 */
	public SKUMARSYNF(long id, Date tradeDate, double openPrice,
			double highPrice, double lowPrice, double lastTradedPrice,
			double closePrice, int totalTradedQuantity, double turnover) {
	 ...
	 * @param strValues
	 */
	public SKUMARSYNF(String[] strValues, int nSource) throws NumberFormatException {
