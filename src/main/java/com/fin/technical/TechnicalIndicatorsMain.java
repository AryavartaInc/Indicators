...
public class TechnicalIndicatorsMain {
    ...
    public TechnicalIndicatorsMain() {
    ...
    public static void main(String[] args) throws RowsExceededException,
        ...
        TechnicalIndicatorsMain objTechnicalIndicatorsMain = new TechnicalIndicatorsMain();
        if (Util.getArchiveStockQuote().equalsIgnoreCase("1")) {
        ...
        if (objTechnicalIndicatorsMain.m_objUtil.getDataSourceSettings().equalsIgnoreCase(
            ...
            try {
                ...
                excep.printStackTrace();
                m_strBufLogOutput
                        .append("An error occurred in main method of TechnicalIndicatorsMain: "
                                + excep.getMessage());
            }
        }
