...
public class GoogleFinanceStockPrice extends StockPrice {

	/**
	 * 
	 */
	public GoogleFinanceStockPrice() {
	 ...
	 */
	public GoogleFinanceStockPrice(String strDate, double dblOpenPrice,
	 ...
	 * @param dblClosePrice
	 */
	public GoogleFinanceStockPrice(double dblHighPrice, double dblLowPrice,
	 ...
	 */
	public GoogleFinanceStockPrice(String[] strValues, int nSource)
			throws NumberFormatException {
